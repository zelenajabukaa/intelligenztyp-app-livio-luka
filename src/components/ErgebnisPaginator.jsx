...
// Hilfsfunktion: KI-Antwort in Seiten aufteilen
function splitIntoPages(text) {
    // Nach doppeltem Zeilenumbruch (Absätze)
    ...
    return (
        <div className="container">
            ...
            <div className="scores">
                {Object.entries(scores).map(([typ, wert]) => (
                    <div key={typ}><b>{typ}:</b> {wert}</div>
                ))}
            </div>
            <div className="page-content" style={{ minHeight: 120, marginBottom: 20 }}>
